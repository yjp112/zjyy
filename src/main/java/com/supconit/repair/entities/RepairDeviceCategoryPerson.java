...
public class RepairDeviceCategoryPerson extends AuditExtend{    
		...
		public RepairDeviceCategoryPerson() {
		}
		
		public RepairDeviceCategoryPerson(RepairDeviceCategoryPerson repairevtcategoryperson) {
