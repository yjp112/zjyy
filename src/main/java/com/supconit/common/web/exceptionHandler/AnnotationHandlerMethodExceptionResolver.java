package com.supconit.common.web.exceptionHandler;
...
public class AnnotationHandlerMethodExceptionResolver extends
	...
	private transient static final Logger log = LoggerFactory.getLogger(AnnotationHandlerMethodExceptionResolver.class);
