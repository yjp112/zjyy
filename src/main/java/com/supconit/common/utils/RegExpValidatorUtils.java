...
public class RegExpValidatorUtils {
	...
	*/
	public static boolean isPassport(String str){
		String regex="^(G[0-9]{8}|[S,P]\\.[0-9]{7}|P[0-9]{7}|S[0-9]{8}|1[4,5][0-9]{7}|D[0-9]+)$"; 
		return match(regex, str);
	}
	...
	* @return 如果是符合格式的字符串,返回 <b>true </b>,否则为 <b>false </b>
	*/
	public static boolean isDriveLicense(String str){
		String regex="^(\\d{12}|\\d{18})$";
		return match(regex, str);
	}
	...
	*/
	...
	String telRegex="^(?:(?:0\\d{2,3}[\\- ]?[1-9]\\d{6,7})|(?:[48]00[\\- ]?[1-9]\\d{6}))$";
	String phoneRegex = "^[1]+[3-9]+\\d{9}$";
	if(match(telRegex, str)||match(phoneRegex, str)){
		return true;
	}
	return false;
	}
