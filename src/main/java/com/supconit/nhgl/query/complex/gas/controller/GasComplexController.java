package com.supconit.nhgl.query.complex.gas.controller;
...
import jodd.datetime.JDateTime;
 ...
 @Controller
@RequestMapping("nhgl/query/complex/gas")
public class GasComplexController extends BaseControllerSupport{
...
//		model.put("gasSubSystemInfoOptions",subSystemInfoOptions(""));
		...
		return "nhgl/query/complex/gas/collect_list";
	}
  
//    private String subSystemInfoOptions(Object checkedValue){
//    	StringBuffer optionsBuffer=new StringBuffer();
//    	List<EnergySubSystemInfo> lstSub=gasSubSystemInfoService.findAll();
...
//    }
    ...
    */
    @ResponseBody
    @RequestMapping("page")
	public Pageable<Complex> page( Pagination<Complex> pager, @ModelAttribute Complex device,
			ModelMap model) {
    	if(device.getSubCode()!=null && device.getSubCode().equals("0")){
    		device.setSubCode("%");
    	}
    	if(device.getLocationId()==null){
    		device.setLocationId(0L); 
    	}
    	deviceService.findByGasConditon(pager, device);
		return pager;
	}
}
