package com.supconit.nhgl.query.complex.energy.controller;
...
import jodd.datetime.JDateTime;
 ...
 @Controller
@RequestMapping("nhgl/query/complex/energy")
public class EnergyComplexController extends BaseControllerSupport{
...
//		model.put("energySubSystemInfoOptions",subSystemInfoOptions(""));
		...
		return "nhgl/query/complex/energy/collect_list";
	}
...
//    }
    ...
    */
	...
	public Pageable<Complex> page( Pagination<Complex> pager, @ModelAttribute Complex device,
    	...
    	deviceService.findByEnergyConditon(pager, device);
		return pager;
	}
}
