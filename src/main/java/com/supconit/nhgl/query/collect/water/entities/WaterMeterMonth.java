package com.supconit.nhgl.query.collect.water.entities;
...
public class WaterMeterMonth extends AuditExtend implements Serializable{
	...
	private String totalMonthValue ;//耗水总量
	...
	private String tbzl;//标识用水量上涨，下降，持平
