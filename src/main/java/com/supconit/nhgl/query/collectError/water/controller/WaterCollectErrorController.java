package com.supconit.nhgl.query.collectError.water.controller;
...
import jodd.datetime.JDateTime;
 ...
 @Controller
@RequestMapping("nhgl/query/collectError/water")
public class WaterCollectErrorController extends BaseControllerSupport{
  ...
  /*  @RequestMapping("list")
	public String list(ModelMap model,Integer nhType) {
		...
		return "nhgl/query/collectError/water/collect_list";
	}*/
