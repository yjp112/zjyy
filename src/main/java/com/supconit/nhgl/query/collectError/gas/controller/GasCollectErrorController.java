package com.supconit.nhgl.query.collectError.gas.controller;
...
import jodd.datetime.JDateTime;
 ...
 @Controller
@RequestMapping("nhgl/query/collectError/gas")
public class GasCollectErrorController extends BaseControllerSupport{
...
//		model.put("gasSubSystemInfoOptions",subSystemInfoOptions(""));
		...
		return "nhgl/query/collectError/gas/collect_list";
	}*/
...
//    }
    ...
    */
	...
	public Pageable<CollectError> page( Pagination<CollectError> pager, @ModelAttribute CollectError condition,
    	...
    	deviceService.findByGasConditon(pager, condition);
		return pager;
	}
}
