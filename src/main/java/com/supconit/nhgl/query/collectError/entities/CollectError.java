package com.supconit.nhgl.query.collectError.entities;
...
public class CollectError extends AuditExtend{    
    ...
    private List<Long> lstDepartmentId;
    private String useDepartmentName;
    private String categoryCode;
    private String energyCode;
    private String serviceArea;
    private Integer nhType;
    private String humanConfirm;
    public List<Long> getLstDepartmentId() {
		return lstDepartmentId;
	}

	public void setLstDepartmentId(List<Long> lstDepartmentId) {
		this.lstDepartmentId = lstDepartmentId;
	}
	...
	public String getHumanConfirm() {
		return humanConfirm;
	}

	public void setHumanConfirm(String humanConfirm) {
		this.humanConfirm = humanConfirm;
	}
