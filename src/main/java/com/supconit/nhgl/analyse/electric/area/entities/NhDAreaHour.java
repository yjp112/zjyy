...
public class NhDAreaHour extends AuditExtend implements CollectHourable{
	...
	private float percentP;
	private Integer deptPid;
	
	public Integer getDeptPid() {
		return deptPid;
	}
	public void setDetpPid(Integer deptPid) {
		this.deptPid = deptPid;
	}
	public float getPercentP() {
		return percentP;
	}
	public void setPercentP(float percentP) {
