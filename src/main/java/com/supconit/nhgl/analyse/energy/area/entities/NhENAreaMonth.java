package com.supconit.nhgl.analyse.energy.area.entities;
...
public class NhENAreaMonth extends AuditExtend implements CollectMonthable{
	...
	private Integer tb;//是否上涨，1上涨，0与上月用电量相同或则上月或当前月的数据不存在，-1表示下降
