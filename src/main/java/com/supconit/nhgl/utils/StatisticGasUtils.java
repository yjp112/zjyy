...
public class StatisticGasUtils {
	...
	public static List<NhQDeptHour> getQDeptSubList(List<NhQDeptHour> nhList, List<NhQDeptHour> nhLastList)
	{	
		BigDecimal tb = new BigDecimal(0);
		if(nhList != null && nhList.size() > 0){
			for(int i=0;i<nhList.size();i++){
				int j=0;
				for(NhQDeptHour nl:nhLastList){
	...
	public static List<NhQAreaHour> getQAreaSubList(List<NhQAreaHour> nhList, List<NhQAreaHour> nhLastList)
	{	
		BigDecimal tb = new BigDecimal(0);
		if(nhList != null && nhList.size() > 0){
			for(int i=0;i<nhList.size();i++){
				int j=0;
				for(NhQAreaHour nl:nhLastList){
	...
	public static Map<String, Object> getDeptHolidayMap(List<NhQDeptDay> nhlst){
	...
	public static Map<String, Object> getAreaHolidayMap(List<NhQAreaDay> nhlst){
		Map<String, Object> map = new HashMap<String, Object>();
		StringBuilder perStr = new StringBuilder();
		StringBuilder data = new StringBuilder();
		StringBuilder lastData = new StringBuilder();
