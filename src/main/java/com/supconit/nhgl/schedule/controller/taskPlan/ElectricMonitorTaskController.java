 ...
 * 
 */
@Controller("nhgl_ycynjc_jcrw_electric_controller")
@RequestMapping("nhgl/basic/taskSet/electric")
public class ElectricMonitorTaskController extends BaseMonitorTaskController{

	/**
	 * 日志服务。
	 */
	private transient static final Logger	logger	= LoggerFactory.getLogger(ElectricMonitorTaskController.class);
	...
	public String edit(ModelMap model) {
		...
		//改为从VIEW_NH_D_AREA中取数据
		List<NgArea> treearea=ngAreaService.findAllDArea();
		...
		List<NhDepartment> treeDept = nhDepartmentService.findAllDDeptWithoutVitualRoot();
		...
		model.put("electricCatagoryCode", electricCatagoryCode);
		return "nhgl/schedule/taskPlan/ycyn/electric/electric";
	}	
	/**
	 * 编辑展示。
	 * 
