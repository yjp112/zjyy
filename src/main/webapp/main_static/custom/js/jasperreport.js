...
function printPDF(printData) {
	...
	var $PrintDiv = $("<div id='infoDiv' style='display:none;'>").html("<font color='#15428B'>���ڼ���PDF�����Ժ�...</font>").appendTo("body");
	...
	//printData = [{path : "/jasperFile/parent.jasper",prt_ref : "1"}, {path : "/jasperFile/chart.jasper",prt_ref : "2"}];
	$.ajax( {
		url : '/UtanJasperReport/PrintServlet',
		data : {
			reportlets : JSON.stringify(printData)
		},
		type : "POST",
...
// ���뱨��ҳ��֮��Ĵ�ӡ����
function printPDF2(jasperParametetId,a) {
	...
	if (isIE=navigator.userAgent.indexOf("MSIE")!=-1) {
		...
		$.blockUI( {
		 ...
		 $.ajax( {
	        url : a+'/duty/dutylog/print',
	        data : {
	            id : jasperParametetId
	        },
			type : "POST",
			complete : function(res, status) {
				if (status == "success") {
