...
window.webcam = {
	...
	swf_url: $.CONTEXT_PATH+'/main_static/custom/js/webcam/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	shutter_url: $.CONTEXT_PATH+'/main_static/custom/js/webcam/shutter.mp3', // URI to shutter.mp3 sound
