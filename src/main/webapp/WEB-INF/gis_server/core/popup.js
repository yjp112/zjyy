		...
		gs_query(typename,"",function(features){
			if(features.length>0){
				for(var i=0;i<features.length;i++){
					...
					//gs_addStatePopup(features[i],"<div style=' margin:0px;' id='"+hpid+"'>3</div>");//+swfurl+hpid
					//$("#"+hpid).load("http://localhost:8080/ywgl/gis/flashPop?hpid="+hpid);
					var local="br";
