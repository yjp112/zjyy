...
function registerVLCEvent(event, handler,objid)
{
    var vlc = getVLC(objid);
...
function unregisterVLCEvent(event, handler,objid)
{
    var vlc = getVLC(objid);
...
// VLC Plugin
function onVLCPluginReady(objid)
{
    registerVLCEvent("MediaPlayerMediaChanged", handleMediaPlayerMediaChanged,objid);
    registerVLCEvent("MediaPlayerNothingSpecial", handle_MediaPlayerNothingSpecial,objid);
    registerVLCEvent("MediaPlayerOpening", handle_MediaPlayerOpening,objid);
    registerVLCEvent("MediaPlayerBuffering", handle_MediaPlayerBuffering,objid);
    registerVLCEvent("MediaPlayerPlaying", handle_MediaPlayerPlaying,objid);
    registerVLCEvent("MediaPlayerPaused", handle_MediaPlayerPaused,objid);
    registerVLCEvent("MediaPlayerStopped", handle_MediaPlayerStopped,objid);
    registerVLCEvent("MediaPlayerForward", handle_MediaPlayerForward,objid);
    registerVLCEvent("MediaPlayerBackward", handle_MediaPlayerBackward,objid);
    registerVLCEvent("MediaPlayerEndReached", handle_MediaPlayerEndReached,objid);
    registerVLCEvent("MediaPlayerEncounteredError", handle_MediaPlayerEncounteredError,objid);
    registerVLCEvent("MediaPlayerTimeChanged", handle_MediaPlayerTimeChanged,objid);
    registerVLCEvent("MediaPlayerPositionChanged", handle_MediaPlayerPositionChanged,objid);
    registerVLCEvent("MediaPlayerSeekableChanged", handle_MediaPlayerSeekableChanged,objid);
    registerVLCEvent("MediaPlayerPausableChanged", handle_MediaPlayerPausableChanged,objid);
    registerVLCEvent("MediaPlayerTitleChanged", handle_MediaPlayerTitleChanged,objid);
    registerVLCEvent("MediaPlayerLengthChanged", handle_MediaPlayerLengthChanged,objid);
}

function close(objid)
{
    unregisterVLCEvent("MediaPlayerMediaChanged", handleMediaPlayerMediaChanged,objid);
    unregisterVLCEvent("MediaPlayerNothingSpecial", handle_MediaPlayerNothingSpecial,objid);
    unregisterVLCEvent("MediaPlayerOpening", handle_MediaPlayerOpening,objid);
    unregisterVLCEvent("MediaPlayerBuffering", handle_MediaPlayerBuffering,objid);
    unregisterVLCEvent("MediaPlayerPlaying", handle_MediaPlayerPlaying,objid);
    unregisterVLCEvent("MediaPlayerPaused", handle_MediaPlayerPaused,objid);
    unregisterVLCEvent("MediaPlayerStopped", handle_MediaPlayerStopped,objid);
    unregisterVLCEvent("MediaPlayerForward", handle_MediaPlayerForward,objid);
    unregisterVLCEvent("MediaPlayerBackward", handle_MediaPlayerBackward,objid);
    unregisterVLCEvent("MediaPlayerEndReached", handle_MediaPlayerEndReached,objid);
    unregisterVLCEvent("MediaPlayerEncounteredError", handle_MediaPlayerEncounteredError,objid);
    unregisterVLCEvent("MediaPlayerTimeChanged", handle_MediaPlayerTimeChanged,objid);
    unregisterVLCEvent("MediaPlayerPositionChanged", handle_MediaPlayerPositionChanged,objid);
    unregisterVLCEvent("MediaPlayerSeekableChanged", handle_MediaPlayerSeekableChanged,objid);
    unregisterVLCEvent("MediaPlayerPausableChanged", handle_MediaPlayerPausableChanged,objid);
    unregisterVLCEvent("MediaPlayerTitleChanged", handle_MediaPlayerTitleChanged,objid);
    unregisterVLCEvent("MediaPlayerLengthChanged", handle_MediaPlayerLengthChanged,objid);
}


/* actions */

function doGo(targetURL,objid)
{
